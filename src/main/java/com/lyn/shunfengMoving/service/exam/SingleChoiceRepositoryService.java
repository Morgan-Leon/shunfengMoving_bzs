...
import com.lyn.shunfengMoving.model.exam.SingleChoice;
import com.lyn.shunfengMoving.repository.exam.SingleChoiceRepository;
...
public class SingleChoiceRepositoryService implements SingleChoiceService{
	...
	/* (non-Javadoc)
	 * @see com.lyn.shunfengMoving.service.exam.SingleChoiceService#add(com.lyn.shunfengMoving.dto.exam.SingleChoiceDTO)
	 */
    @Transactional
	@Override
	...
	/* (non-Javadoc)
	 * @see com.lyn.shunfengMoving.service.exam.SingleChoiceService#update(com.lyn.shunfengMoving.dto.exam.SingleChoiceDTO, java.lang.Long)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.lyn.shunfengMoving.service.exam.SingleChoiceService#findById(java.lang.Long)
	 */
	...
	/* (non-Javadoc)
	 * @see com.lyn.shunfengMoving.service.exam.SingleChoiceService#deleteById(java.lang.Long)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.lyn.shunfengMoving.service.exam.SingleChoiceService#findAll(org.springframework.data.domain.Pageable)
	 */
	@Override
